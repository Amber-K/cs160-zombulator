...
function initializeHumans() {
  ...
  for (var i = 0; i < NUMBER_OF_HUMANS; ++i) {
    ...
    humanYs[i] = random(300, windowHeight);
...
/*function initializeHumans() {
  humanXs = random(0, windowWidth);
  humanYs = random(windowHeight - 200, windowHeight);
  humanSizes = random(MIN_SIZE, MAX_SIZE);
  humanColors = color(random(50, 255), random(50, 255), random(50, 255), 150);
}*/
